	        ...
	        <div class="row">
	            ...
	            <div class="col-lg-12" style="padding-bottom:120px">
	                ...
	                <form action="datphong" method="POST">
	                    ...
	                    <div class="form-group">
	                        <label>SĐT</label>
	                        <input class="form-control" name="sdt" placeholder="Nhập số điện thoại"  value="{{-- {{ Auth::user()->email }} --}}" />
	                    </div>

						{{-- Enter CMND --}}
	                    <div class="form-group">
	                        <label>CMND</label>
	                        <input class="form-control" name="cmnd" placeholder="Nhập số chứng mình nhân dân"  value="{{-- {{ Auth::user()->email }} --}}" />
	                    </div>
	
	                    {{-- Enter Tuoi --}}
	                    <div class="form-group">
	                        <label>Tuổi</label>
	                        <input type="number" class="form-control" name="tuoi" placeholder="Nhập số tuổi"  value="{{-- {{ Auth::user()->email }} --}}" />
	                    </div>

	                    {{-- Enter Quốc tịch --}}
	                    <div class="form-group">
	                        <label>Quốc tịch</label>
	                        <input class="form-control" name="quoctich" placeholder="Nhập quốc tịch"  value="{{-- {{ Auth::user()->email }} --}}" />
	                    </div>
