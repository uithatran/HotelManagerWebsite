	                    ...
	                    <input type="hidden" name="_token" value="{{ csrf_token() }}" />
	              			@if(Auth::user())
			                    <div class="form-group">
			                        ...
			                        <input class="form-control" name="tenkhachhang" placeholder="Nhập tên tài khoản" value="{{ Auth::user()->name }}" disabled="" />
			                    </div>
							...
							@else
			                    ...
			                    <div class="form-group">
			                        <label>CMND</label>
			                        <input class="form-control" name="cmnd" placeholder="Nhập số chứng mình nhân dân"  value="241535833" />
			                    </div>
			
			                    {{-- Enter Tuoi --}}
			                    <div class="form-group">
			                        <label>Tuổi</label>
			                        <input type="number" class="form-control" name="tuoi" placeholder="Nhập số tuổi"  value="18" />
			                    </div>

			                    {{-- Enter Quốc tịch --}}
			                    <div class="form-group">
			                        <label>Quốc tịch</label>
			                        <input class="form-control" name="quoctich" placeholder="Nhập quốc tịch"  value="Việt Nam" />
			                    </div>
